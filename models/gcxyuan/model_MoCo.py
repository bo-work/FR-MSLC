...
class MoCo(nn.Module):
    ...
    def __init__(self, base_encoder, config):
        ...
        #encoder
        self.encoder_q = base_encoder(input_dim = config['input_dim'], num_class=config['num_classes'],low_dim=config['low_dim'])
        #momentum encoder
        self.encoder_k = base_encoder(input_dim = config['input_dim'], num_class=config['num_classes'],low_dim=config['low_dim'])
        #decoder
        ...
        self.register_buffer("prototypes", torch.zeros(config['num_classes'],config['low_dim']))
